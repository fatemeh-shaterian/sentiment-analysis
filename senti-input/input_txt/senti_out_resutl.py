...
def main(i):
    ...
    if not my_input_file.closed:
        ...
        for line in (my_input_file.readlines()):
            ...
            text_list2.append([issueid, userid, pos, neg, reaction_pos , reaction_neg ,(reaction_pos-reaction_neg)])
            #print (text_list)
            #print (rr)
...
with open('./result/alloutput2' + '.csv', 'wb') as csv_file:
    ...
    writer2.writerow(['issueId', 'user' 'pos', 'neg' , 'reaction_pos' , 'reaction_neg', 'reaction'])
...
print( totalNeg+totalPlus+totalConflict )
